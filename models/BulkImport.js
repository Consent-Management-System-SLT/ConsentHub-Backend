...
// Method to add error
bulkImportSchema.methods.addError = function (
  row,
  field,
  value,
  message,
...
bulkImportSchema.methods.updateProgress = function (
  processed,
  successful = 0,
  skipped = 0,
) {
...
bulkImportSchema.statics.getImportStats = async function (
  userId = null,
  timeframe = 30,
) {
  const matchStage = {
