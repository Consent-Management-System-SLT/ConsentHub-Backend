...
externalPartyMappingSchema.index(
  { sourceSystem: 1, externalCustomerId: 1 },
  { unique: true },
);
externalPartyMappingSchema.index({ partyId: 1 });

module.exports =
  mongoose.models["ExternalPartyMapping"] ||
  mongoose.model("ExternalPartyMapping", externalPartyMappingSchema);
